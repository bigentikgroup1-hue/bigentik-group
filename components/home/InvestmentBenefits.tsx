      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-16">
          <div className="space-y-6">
            ...
            <h3 className="font-headline text-2xl italic">{t('home.investment.cards.0.title')}</h3>
          ...
          <div className="space-y-6">
            <div className="h-1 w-12 bg-primary"></div>
            <h3 className="font-headline text-2xl italic">{t('home.investment.cards.1.title')}</h3>
            <p className="text-on-surface-variant leading-relaxed">
          ...
          <div className="space-y-6">
            <div className="h-1 w-12 bg-primary"></div>
            <h3 className="font-headline text-2xl italic">{t('home.investment.cards.2.title')}</h3>
            <p className="text-on-surface-variant leading-relaxed">
