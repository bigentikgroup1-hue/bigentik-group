...
export const InvestmentHighlights = async ({ locale }: { locale: string }) => {
  ...
  return (
    <section className="py-32 max-w-7xl mx-auto px-6">
      <h2 className="tracking-[0.1em] uppercase font-urbanist text-3xl mb-16 text-center">{t('projects.highlights.title')}</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-surface-container p-10 group hover:bg-primary transition-colors duration-500">
          <span className="material-symbols-outlined text-4xl  mb-6 group-hover:text-on-primary">
            trending_up
          </span>
          <h4 className="font-headline text-xl mb-4 group-hover:text-on-primary">
            {t('projects.highlights.growth_title')}
          </h4>
          <p className=" group-hover:text-on-primary/80">
