      ...
      <form className="space-y-10" onSubmit={handleSubmit}>
        ...
        <div className="relative">
          ...
          <select className="w-full bg-transparent border-0 border-b border-outline-variant/40 focus:ring-0 focus:border-primary px-0 py-2 transition-all">
            <option>{dict.contact.form.interest_opts[0]}</option>
            <option>{dict.contact.form.interest_opts[1]}</option>
            <option>{dict.contact.form.interest_opts[2]}</option>
            <option>{dict.contact.form.interest_opts[3]}</option>
          </select>
        </div>
