      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="md:col-span-12 grid grid-cols-2 md:grid-cols-5 gap-12">
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-on-surface-variant">
                ...
                <li><Link className="hover:text-primary transition-colors" href="/projects">{dict.footer.nav_projects}</Link></li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-on-surface-variant">
                {projects.map((project) => (
                  <li key={project.slug}>
                    <Link className="hover:text-primary transition-colors" href={`/${locale}/projects/${project.slug}`}>
        ...
        <div className="pt-10 border-t border-outline-variant/30 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a className="text-on-surface-variant hover:text-primary transition-colors" href="https://instagram.com/bigentikgroup" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a className="text-on-surface-variant hover:text-primary transition-colors" href="https://web.facebook.com/profile.php?id=61550309097362" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
