      ...
      <section className="relative min-h-[80vh] flex items-center px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-12 gap-6 items-center">
          <div className="col-span-12 lg:col-span-7 z-10">
            ...
            <h1 className="font-headline text-6xl lg:text-8xl leading-[1.1] mb-8 text-balance -tracking-wider">{t('about.hero.title_1')} <span className="italic text-primary">{t('about.hero.title_2')}</span></h1>
            <div className="w-24 h-1 bg-primary mb-8"></div>
            <p className="text-xl text-on-surface-variant max-w-lg leading-relaxed">{t('about.hero.description')}</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-12 gap-12">
            <div className="col-span-12 lg:col-span-4">
              <h2 className="font-headline text-4xl leading-tight text-balance">{t('about.philosophy.title_1')} <span className="italic">{t('about.philosophy.title_2')}</span></h2>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-12 gap-12 items-center">
          <div className="col-span-12 lg:col-span-6 order-2 lg:order-1">
            <div className="border-l-4 border-primary pl-12 py-4">
              <blockquote className="font-headline text-3xl lg:text-4xl italic leading-relaxed text-on-surface mb-8">{t('about.founder.quote')}</blockquote>
      ...
      <section className="py-32 bg-surface-container-low">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16">
            ...
            <h2 className="font-headline text-5xl text-center">{t('about.presence.title_1')} <span className="italic">{t('about.presence.title_2')}</span></h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px]">
            <div className="md:col-span-2 md:row-span-2 bg-surface-container-highest p-12 flex flex-col justify-end relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h3 className="text-4xl font-headline mb-4">{t('about.presence.portal_title')}</h3>
                <p className="max-w-xs text-on-surface-variant mb-6">{t('about.presence.portal_desc')}</p>
            ...
            <div className="md:col-span-2 bg-primary text-on-primary p-12 flex items-center">
              <div>
                <span className="text-5xl font-headline italic mb-2 block">{t('about.presence.aum_val')}</span>
                <p className="text-sm font-label uppercase tracking-widest opacity-80">{t('about.presence.aum_lbl')}</p>
              </div>
            </div>
            <div className="md:col-span-2 bg-surface-container-lowest p-8 flex flex-col justify-center text-center">
              <span className="material-symbols-outlined text-primary text-4xl mb-4">public</span>
              <h4 className="font-semibold uppercase text-xs tracking-widest">{t('about.presence.cities')}</h4>
            </div>
          </div>
        </div>
      </section>
