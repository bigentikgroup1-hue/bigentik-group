        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 order-1 lg:order-2 flex justify-center">
            <div className="relative w-full max-w-md lg:max-w-none aspect-square bg-surface-container overflow-hidden p-4 md:p-6 mx-auto">
              <Image className="object-cover filter sepia-[0.2] transition-transform duration-700" data-alt="Professional portrait of a founder in a modern office" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAzDw1Myxqv_y0grPDmMHFXCSUrmnwhRZj8EkU7aMfj8uwEnHIF9q7pd0HLTUPLHTPRyeNFbEPqltR2Ldu_SbB4s3j0ieXtTIOYB9QPxOnzGAVWowF1Qxf2SiOMwLtUeSoGGN_q6EcNIv8rcXJu8sD9DJ5VuKpFTOVMNv6ZRWogrqf5ZJ1s4MluXQiKNrJgH2nvC6f0TYcIed0RJj7VVLvSUj7K0-4ZV6MLV9LtyO60KBmlktmziI6IGKnlaGM3Zp-w9XOIig8piw" alt="Professional portrait of a founder in a modern office" fill quality={100} />
            </div>
          </div>
        </div>
      </section>
