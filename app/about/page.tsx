        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-12">
            ...
            <div className="hidden lg:flex items-center gap-8">
              <a className="text-sm font-label uppercase tracking-widest text-on-surface/70 hover:text-primary transition-colors" href="#">Inicio</a>
              <a className="text-sm font-label uppercase tracking-widest text-primary font-semibold" href="#">Proyectos</a>
              <a className="text-sm font-label uppercase tracking-widest text-on-surface/70 hover:text-primary transition-colors" href="#">Sobre Nosotros</a>
              <a className="text-sm font-label uppercase tracking-widest text-on-surface/70 hover:text-primary transition-colors" href="#">Inversión</a>
              <a className="text-sm font-label uppercase tracking-widest text-on-surface/70 hover:text-primary transition-colors" href="#">Contacto</a>
            </div>
          </div>
            ...
            <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-3 gap-8">
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-on-surface-variant">
                  ...
                  <li><a className="hover:text-primary transition-colors" href="#">Portal de Inversión</a></li>
                </ul>
              </div>
              <div className="space-y-4">
                <h5 className="text-xs font-label uppercase tracking-[0.2em] text-on-surface font-bold">Soporte</h5>
                <ul className="space-y-2 text-sm text-on-surface-variant">
                  <li><a className="hover:text-primary transition-colors" href="#">Contáctenos</a></li>
                  <li><a className="hover:text-primary transition-colors" href="#">Ubicaciones de Oficinas</a></li>
